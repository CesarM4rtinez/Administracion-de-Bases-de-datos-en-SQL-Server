...
INSERT INTO DIM_TIEMPO (FECHAKEY, Fecha, Año, Trimestre, Mes, Semana, Dia, DiaSemana, NTrimestre, NMes, NMesL, NSemana, NDia, NDiaSemana)
...
CREATE TABLE HECHOS(
   ...
   CONSTRAINT FK_HECHOS_FECHA       FOREIGN KEY (FECHA)               REFERENCES DIM_TIEMPO (FECHA),
